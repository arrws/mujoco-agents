...
class Network:
    def __init__(self, hidden_sizes=(63,64), activation=tf.tanh, output_activation=None, policy=None, action_space=None, observation_space=None, gamma=0.99, clip_ratio=0.2,  pi_lr=3e-4, vf_lr=1e-3):
...
def ppo(env_fn, ac_kwargs=dict(), seed=0,
    ...
    def update():
        ...
        pi_l_new, v_l_new, kl, cf = sess.run([net.pi_loss, net.v_loss, net.approx_kl, net.clipfrac], feed_dict=inputs)
